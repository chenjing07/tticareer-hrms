   ...
   // viewModel: {type: 'orderViewModel'},
    ...
    items: [{
            ...
            columns: [
	           ...
	           {xtype: 'gridcolumn',cls:'content-column',width:120,dataIndex: 'resumeId',text: 'Resume Id'},
	           {xtype: 'gridcolumn',cls:'content-column',width:120,dataIndex: 'examContentId',text: 'Exam Content Id'},
		    ...
		    {xtype: 'datecolumn',cls: 'content-column', width:160,dataIndex: 'examEnd',text: 'Exam End',renderer:Ext.util.Format.dateRenderer('Y/m/d H:i:s'),hidden:true},
	           {xtype: 'gridcolumn',cls:'content-column',width:120,dataIndex: 'examScore',text: 'Exam Score'},
	           {xtype: 'gridcolumn',cls:'content-column',width:120,dataIndex: 'examResult',text: 'Exam Result'},
