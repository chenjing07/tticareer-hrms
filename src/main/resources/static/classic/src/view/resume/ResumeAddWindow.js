Ext.define('Admin.view.resume.ResumeAddWindow', {
    ...
    items: [{
        ...
        layout: 'form',
        padding: '10px',
        ariaLabel: 'Add Resume Information',
        items: [{
            xtype: 'textfield',
            fieldLabel: 'id',
            name:'id',
    ...
    buttons:  [{
        xtype: 'button',
        text: 'Submit',
        handler: 'resumeAddSubmitButton'//预留提交事件，在ViewController中实现
    },{
        xtype: 'button',
        text: 'Close',
