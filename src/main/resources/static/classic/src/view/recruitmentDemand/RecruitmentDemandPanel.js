   ...
   // viewModel: {type: 'orderViewModel'},
    ...
    items: [{
            ...
            columns: [
	           ...
	           {xtype: 'gridcolumn',cls:'content-column',width:120,dataIndex: 'positionId',text: 'Position Id'},
	           {xtype: 'gridcolumn',cls:'content-column',width:120,dataIndex: 'planNumber',text: 'Plan Number'},
	           {xtype: 'gridcolumn',cls:'content-column',width:120,dataIndex: 'salary',text: 'Salary',hidden:true},
	           {xtype: 'gridcolumn',cls: 'content-column',width:120,dataIndex: 'supplementalNumber',text: 'Supplemental Number'},
		    {xtype: 'gridcolumn',cls: 'content-column',width:120,dataIndex: 'supplementReason',text: 'Supplement Reason'},
		    {xtype: 'datecolumn',cls: 'content-column',width:160,dataIndex: 'arrivalDate',text: 'Arrival Date',renderer:Ext.util.Format.dateRenderer('Y/m/d H:i:s')},
		    ...
		    {xtype: 'gridcolumn',cls: 'content-column',width:120,dataIndex: 'state',text: 'State',hidden:true},
