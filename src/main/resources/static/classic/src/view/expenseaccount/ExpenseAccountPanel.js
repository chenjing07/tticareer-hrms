Ext.define('Admin.view.expenseaccount.ExpenseAccountPanel', {
    ...
    items: [{
           ...
           {xtype: 'gridcolumn',cls:'content-column',dataIndex: 'amount',text: 'Amount',flex:1},
       	   {xtype: 'gridcolumn',cls:'content-column',dataIndex: 'reason',text: 'Reason',flex:1},
       	{xtype: 'gridcolumn',cls:'content-column',dataIndex: 'content',text: 'Content',flex:2},
           ...
           {xtype: 'datecolumn',cls: 'content-column',dataIndex: 'time',text: 'Time',renderer:Ext.util.Format.dateRenderer('Y/m/d')},
