Ext.define('Admin.view.employeePositionInfo.EmployeePositionInfoEditWindow', {
    extend: 'Ext.window.Window',
    alias: 'widget.employeePositionInfoEditWindow',
    ...
    width: 500,
    scrollable: true,
    title: 'EmployeePositionInfo Edit Window',
    closable: true,
    ...
    items: [{
        ...
        items: [{
            ...
            xtype: 'textfield',
            fieldLabel: 'EmployeePositionInfo Number',
            name:'employeePositionInfo_number'
        }, {
            xtype: 'textfield',
            fieldLabel: 'Password',
            name:'password'
