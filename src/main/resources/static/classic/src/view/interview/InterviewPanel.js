   ...
   // viewModel: {type: 'orderViewModel'},
    ...
    items: [{
		    ...
		    {xtype: 'datecolumn',cls: 'content-column', width:160,dataIndex: 'oneEnd',text: 'One End',renderer:Ext.util.Format.dateRenderer('Y/m/d H:i:s'),hidden:true},
	           {xtype: 'gridcolumn',cls:'content-column',width:120,dataIndex: 'oneFeedback',text: 'One Feedback',hidden:true},
		    ...
		    {xtype: 'gridcolumn',cls:'content-column',width:120,dataIndex: 'twoFeedback',text: 'Two Feedback',hidden:true},
