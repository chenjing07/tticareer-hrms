   ...
   // viewModel: {type: 'orderViewModel'},
    ...
    items: [{
            ...
            columns: [
	           ...
	           {xtype: 'gridcolumn',cls:'content-column',width:100,dataIndex: 'question',text: 'Question'},
	           {xtype: 'gridcolumn',cls:'content-column',width:100,dataIndex: 'answer',text: 'Answer'},
	           {xtype: 'gridcolumn',cls:'content-column',width:100,dataIndex: 'score',text: 'Score'},
	           {xtype: 'gridcolumn',cls:'content-column',width:120,dataIndex: 'difficultyLevel',text: 'Difficulty Level'},
	           {xtype: 'gridcolumn',cls:'content-column',width:100,dataIndex: 'category',text: 'Category'},
	           {xtype: 'gridcolumn',cls:'content-column',width:120,dataIndex: 'explanation',text: 'Explanation',hidden:true},
